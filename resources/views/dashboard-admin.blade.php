<x-app-layout>
    ...
    <section class="grid grid-flow-row-dense sm:grid-cols-5">
        <div>
            <div class="hidden sm:block max-w-full w-fit col-start-1 col-end-2">
                <div class="flow-root py-3 shadow-sm bg-white">
                    <nav class="grid grid-flow-row grid-rows-8 px-3 py-5 h-screen w-72">
                        <div class=" row-span-7 px-3 py-5">
                            ...
                            <h1 class=" font-bold text-2xl border-b-2 border-red-600">MENU</h1>
                            <a href="{{ route('dashboard-admin2') }}"
                                class="text-md flex justify-start items-center border-r-4 hover:border-red-600 hover:text-red-600 px-2 py-2 mt-5 {{ request()->routeIs('dashboard-admin2') ? 'text-red-600 font-bold bg-red-100 rounded-sm border-red-600' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="-ml-0.5 mr-1.5 h-6 w-6">
                            ...
                            <a href="{{ route('admin.users.index') }}"
                                class="text-md flex justify-start items-center border-r-4 hover:border-red-600 hover:text-red-600 px-2 py-2 mt-3 {{ request()->routeIs('admin.users.index') ? 'text-red-600 font-bold bg-red-100 rounded-sm border-red-600' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="-ml-0.5 mr-1.5 h-6 w-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="{{ route('admin.Pesertas.index') }}"
                                class="text-md flex justify-start items-center border-r-4 hover:border-red-600 hover:text-red-600 px-2 py-2 mt-3 {{ request()->routeIs('admin.Pesertas.index') ? 'text-red-600 font-bold bg-red-100 rounded-sm border-red-600' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="-ml-0.5 mr-1.5 h-6 w-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Zm6-10.125a1.875 1.875 0 1 1-3.75 0 1.875 1.875 0 0 1 3.75 0Zm1.294 6.336a6.721 6.721 0 0 1-3.17.789 6.721 6.721 0 0 1-3.168-.789 3.376 3.376 0 0 1 6.338 0Z" />
                            ...
                            <a href="{{ route('admin.proposals.index') }}"
                                class="text-md flex justify-start items-center border-r-4 hover:border-red-600 hover:text-red-600 px-2 py-2 mt-3 {{ request()->routeIs('admin.proposals.index') ? 'text-red-600 font-bold bg-red-100 rounded-sm border-red-600' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class=" -ml-0.5 mr-1.5 w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <a href="{{ route('admin.timelines.index') }}"
                                class="text-md flex justify-start items-center border-r-4 hover:border-red-600 hover:text-red-600 px-2 py-2 mt-3 {{ request()->routeIs('admin.timelines.index') ? 'text-red-600 font-bold bg-red-100 rounded-sm border-red-600' : '' }}">
