        ...
        <div class="flex justify-end">
            ...
            <div class="hidden sm:block max-w-full w-80 col-start-1 col-end-2 sm:px-6 lg:px-8">
                <div class="flow-root rounded-lg border border-gray-100 py-3 shadow-sm bg-white">
                    <nav class="grid grid-flow-row gap-3 flex justify-center px-3 py-5">
                        <div>
                        ...
                        <a href="{{ route('dashboard') }}"
                            class="text-sm flex justify-start items-center {{ request()->routeIs('dashboard') ? 'text-indigo-900 font-bold' : '' }}">
                        ...
                        <a href="{{ route('data-diri') }}"
                            class="text-sm flex justify-start items-center {{ request()->routeIs('data-diri') ? 'text-indigo-900 font-bold' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="-ml-0.5 mr-1.5 h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <a href="{{ route('myproject') }}"
                            class="text-sm flex justify-start items-center {{ request()->routeIs('myproject') ? 'text-indigo-900 font-bold' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="-ml-0.5 mr-1.5 h-5 w-5">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="{{ route('logout') }}"
                                ...
                                class="text-red-600 font-bold border border-red-600 rounded-md text-sm flex justify-center items-center p-2">
                                {{ __('Log Out') }}
                            </a>
                        </form>
                    </nav>
