        ...
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="lg:flex lg:items-center lg:justify-between mt-2">
                ...
                <div class="mt-5 flex lg:ml-4 lg:mt-0">
                    ...
                    @else
                        @if ($adaKolomKosong || $daftar->kelompok->nama_kelompok == null || $anggota <= 2)
                            <span class="sm:ml-3">
                                <button type="button" disabled
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah Kamu Yakin Mau
                        mempublish
                        nya?</h3>
