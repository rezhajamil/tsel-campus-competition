        ...
        <div class="bg-white px-10 py-8  mx-5 rounded-lg">
            <div id="accordion-collapse" data-accordion="collapse">
                <h2 id="accordion-collapse-heading-1">
                    <button type="button"
                        class="{{ count($pesertaList)>=3 && count($pesertaList) <= 4 ? 'bg-red-200 text-red-700' : 'bg-emerald-200 text-emerald-700' }} flex items-center justify-between w-full p-5 font-medium border rounded-t-xl  "
                        ...
                        <div class="flow-root rounded-lg border border-gray-100 py-3 shadow-sm">
                            <dl class="-my-3 divide-y divide-gray-100 text-sm">
                                ...
                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <dd class="text-gray-700 sm:col-span-2 uppercase">{{ $data->ide_bisnis }}</dd>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <dd class="text-gray-700 sm:col-span-2">
                                        <a
                                            href="{{ asset('storage/model_bisnis_canvas/' . $data->model_bisnis_canvas) }}">
                                            <button type="button"
                                ...
                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <dd class="text-gray-700 sm:col-span-2">{{ $data->deskripsi_laba_rugi }}</dd>
                                </div>

                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    <dt class="font-medium text-gray-900">File Laba Rugi</dt>
                                    <dd class="text-gray-700 sm:col-span-2">
                                        <a href="{{ asset('storage/file_laba_rugi/' . $data->file_laba_rugi) }}">
                                            <button type="button"
                                                class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                ...
                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <dd class="text-gray-700 sm:col-span-2">{{ $data->deskripsi_pemasaran }}</dd>
                                </div>

                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    <dt class="font-medium text-gray-900">File Pemasaran</dt>
                                    <dd class="text-gray-700 sm:col-span-2">
                                        <a href="{{ asset('storage/file_pemasaran/' . $data->file_pemasaran) }}">
                                            <button type="button"
                                                class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                ...
                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <dd class="text-gray-700 sm:col-span-2">{{ $data->deskripsi_maintenance }}</dd>
                                </div>

                                <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
                                    <dt class="font-medium text-gray-900">File Maintenance</dt>
                                    <dd class="text-gray-700 sm:col-span-2">
                                        <a href="{{ asset('storage/file_maintenance/' . $data->file_maintenance) }}"><button
                                                type="button"
                                                class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center  me-2 mb-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
