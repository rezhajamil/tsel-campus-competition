    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Judul -->
                <div class="shrink-0 flex items-center justify-center sm:justify-center w-full">
                    <span class="font-batik text-sm sm:text-2xl">Telkomsel Campus Competition</span>
                </div>
            </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 px-4 space-y-1">
                <h1 class=" font-bold text-2xl my-3">Menu</h1>
                        <x-responsive-nav-link href="" class="text-lg flex justify-start items-center">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();" class="text-white bg-red-600 rounded-md">
                        {{ __('Log Out') }}
